...
import VHSSvgFilter from "@/components/VHSSvgFilter";

export default function Home() {
  return (
    <div className="crt-frame">
      {/* SVG filter definitions (invisible, just defines the filters) */}
      <VHSSvgFilter />

      {/* All visible content wrapped in VHS distortion + chroma shift */}
      <div className="absolute inset-0 vhs-content">
        <div className="absolute inset-0 vhs-chroma">
          <WeatherBackground />
          ...
          <div className="relative z-10 flex flex-col h-full p-[3%]">
            ...
            <header className="flex items-start justify-between mb-[2%]">
              ...
              >
                <div className="text-[1.8vmin]">MER AVR 02</div>
            ...
            <div className="flex-1 flex flex-col items-center justify-start gap-[2%]">
              ...
              {/* Details panel */}
              <div className="broadcast-panel w-[90%]">
                <div className="panel-header text-[1.8vmin]">détails</div>
                <div
                ...
                >
                  <div>
                    <span style={{ color: "var(--wc-blue-text)" }}>
                      HUMIDITÉ
                    </span>{" "}
                  ...
                  <div>
                    ...
                    <span style={{ color: "var(--wc-yellow)" }}>
                      NO 12 km/h
                    </span>
                  </div>
                  <div>
            ...
            <div className="mt-auto">
              ...
              >
                ACTUELLEMENT À{" "}
                <span style={{ color: "var(--wc-yellow)" }}>PARIS</span>
              ...
              >
                <div className="inline-block animate-marquee">
                  BULLETIN MÉTÉO ━ PARIS : 18°C DÉGAGÉ ━ HUMIDITÉ 54% ━ VENT NO
                  12 KM/H ━ PROCHAINES HEURES : CIEL DÉGAGÉ ━ THE VAPOR CHANNEL
                  ━ MÉTÉO EN DIRECT ━
                </div>
              </div>
            </div>
      ...
      {/* WebGL overlay (scanlines, noise, vignette, glitch, phosphor) */}
      <VHSEffects />
